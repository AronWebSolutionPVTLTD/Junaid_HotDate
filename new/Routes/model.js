...
router.put("/update_model", verifyToken,upload.fields(
...
router.post("/:modelId/follow_request",verifyToken,modelController.follow_request)
router.post("/:modelId/:followerId/update_follow_request",verifyToken,modelController.update_follow_request);
router.put("/update_wallet",verifyToken,modelController.update_wallet)

router.put("/booking_model/:modelId",verifyToken,modelController.booking_model)
