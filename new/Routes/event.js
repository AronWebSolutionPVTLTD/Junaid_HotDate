...
router.put("/update_event",verifyToken,upload.fields([ { name: 'mainImage', maxCount: 1 },{ name: 'images', maxCount: 1000*100*10 }, { name: 'videos', maxCount: 1000*100*10 }]),eventController.update_event)
