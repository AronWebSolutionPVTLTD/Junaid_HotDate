    ...
    try {
      ...
      if (!data) {
        ...
        let mailOptions = {
          ...
          html: `<h1>Reset Password </h1><br><h4> Your password is changed successfully please login with your newly created credentials</h4>`,
        };
        Mailsend(req, res, mailOptions);
    ...
    try {
      ...
      if (!data) {
        ...
        let mailOptions = {
          ...
          html: `<h1>Change Password </h1><br><h4> Your password is changed successfully please login with your newly created credentials</h4>`,
        };
        Mailsend(req, res, mailOptions);
